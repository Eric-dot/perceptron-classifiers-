...
def classify(activation_polarity, activation_origin):
    return ["True" if activation_origin > 0 else "Fake", "Pos" if activation_polarity > 0 else "Neg"]


#model_file = sys.argv[1]
#testing_data = sys.argv[2]
model_file = "vanillamodel.txt"
testing_data = "dev-text.txt"
...
with open(testing_data, encoding='utf-8') as input_file:
    ...
    for line in lines:
        ...
        output.write(line[0:7] + ' ' + prediction[0] + ' ' + prediction[1] + '\n')
    output.close()
